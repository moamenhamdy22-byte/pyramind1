...
<body>
                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="detail.php" class="dropdown-item active">Tracks Detail</a>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Tracks Detail</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Tracks Detail</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Tracks Detail</h6>
                            <h1 class="display-4">Web design & development Tracks for beginners</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/header.jpg" alt="Image">
                        <p>"Launch your tech career with our beginner-friendly Web Design & Development tracks! Master HTML, CSS, JavaScript, and modern frameworks through hands-on projects. Whether you want to build stunning websites or dive into full-stack development, our step-by-step courses give you real-world skills – no prior experience needed. Start creating your first professional portfolio from day one!"</p>
                        
                      
                    </div>

                    <h2 class="mb-3">Related Tracks</h2>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        <h3 class="text-white py-3 px-4 m-0">Tracks Features</h3>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Instructor</h6>
                            <h6 class="text-white my-3">Amir krara</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                        ...
                        <h5 class="text-white py-3 px-4 m-0">Tracks Price: 50</h5>
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="">Watch Now</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Web design & development Tracks for
                                beginners</a>
                                <span class="badge badge-primary badge-pill">150</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Accounting</a>
                                <span class="badge badge-primary badge-pill">131</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">Marketing</a>
                                <span class="badge badge-primary badge-pill">78</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">CEO</a>
                                <span class="badge badge-primary badge-pill">56</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="" class="text-decoration-none h6 m-0">System Analysis</a>
                    ...
                    <div class="mb-5">
                        <h2 class="mb-4">Recent Tracks</h2>
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
                                <h6>Web design & development Tracks for beginners</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Amir krara</small>
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            ...
                            <div class="pl-3">
                                <h6>Marketing</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Ayman Hefny</small>
                                    <small class="text-body"><i class="fa fa-star text-primary mr-2"></i>4.6 (250)</small>
                                </div>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            ...
                            <div class="pl-3">
                                <h6>Accounting</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Mahmoud alkhateeb</small>
                                    <small class="text-body"><i class="fa fa-star text-primary mr-2"></i>4.7 (250)</small>
                                </div>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none" href="">
                            ...
                            <div class="pl-3">
                                <h6>CEO</h6>
                                <div class="d-flex">
                                    <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>Haidy</small>
                                    <small class="text-body"><i class="fa fa-star text-primary mr-2"></i>4.5 (250)</small>
                                </div>
                            </div>
                        </a>

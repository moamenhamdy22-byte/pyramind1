...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center my-5 py-5">
            ...
            <h1 class="text-white display-1 mb-5">Education Tracks</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 my-5 pt-5 pb-lg-5">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Why Choose Us?</h6>"Choose Pyramind for expert-led, flexible, and affordable online courses that equip you with real-world skills and lifetime access—start learning today!"
        ...
        <div class="owl-carousel courses-carousel">
            <div class="courses-item position-relative">
                ...
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">Web design & development Tracks for beginners</h4>
                    ...
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="detail.php">Tracks Detail</a>
                    </div>
                </div>
            </div>
            <div class="courses-item position-relative">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <select class="custom-select bg-light border-0 px-3" style="height: 60px;">
                                        ...
                                        <option value="2">Tracks 1</option>
                                        <option value="3">Tracks 1</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Amany Elnahas</h5>
                ...
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mahmoud alkhateeb</h5>
                        <p class="mb-2">Accounting</p>
                        <div class="d-flex justify-content-center">
                            <a class="mx-1 p-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="mx-1 p-1" href="#"><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="m-0">"Our students rave about Pyramind—transforming careers, unlocking new skills, and achieving their goals, one course at a time!"</p>
                </div>
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <p>"Best investment ever! The flexible lessons fit my schedule, and the community support kept me motivated."</p>
                        ...
                        <div class="bg-white p-5">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <p>"Pyramind transformed my career—their hands-on courses gave me the skills to land my dream job in just 3 months!"</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <p class="m-0">About Pyramind – Your First Choice for Online Education At Pyramind, we believe that learning should be accessible, flexible, and transformative. As a leading online education platform, we empower students, professionals, and lifelong learners worldwide with high-quality courses designed to help them achieve their personal and career goals.</p>
                </div>
                <div class="col-md-6 mb-5">
